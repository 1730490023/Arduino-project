...
// Serial Console Messages
	...
	#define MSG_M115_REPORT "FIRMWARE_NAME:XIN S1; Sprinter/grbl mashup for gen6 FIRMWARE_URL:" FIRMWARE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) " UUID:" MACHINE_UUID "\n"
...
// LCD Menu Messages
	...
	#define MSG_MAIN             "Hauptmen鐪�
	#define MSG_AUTOSTART        "Autostart"
	#define MSG_DISABLE_STEPPERS "Stepper abschalten"
	#define MSG_AUTO_HOME        "Auto Nullpunkt"
	#define MSG_SET_ORIGIN       "Setze Nullpunkt"
	#define MSG_PREHEAT_PLA      "Vorw鐩瞨men PLA"
	#define MSG_PREHEAT_PLA_SETTINGS "Vorw鐩瞨men PLA Einstellungen"
	#define MSG_PREHEAT_ABS      "Vorw鐩瞨men ABS"
	#define MSG_PREHEAT_ABS_SETTINGS "Vorw鐩瞨men ABS Einstellungen"
	#define MSG_COOLDOWN         "Abk鐪塰len"
	#define MSG_SWITCH_PS_ON     "Switch Power On"
	#define MSG_SWITCH_PS_OFF    "Switch Power Off"
	#define MSG_EXTRUDE          "Extrude"
	#define MSG_RETRACT          "Retract"
	...
	#define MSG_NOZZLE           "D鐪塻e"
	#define MSG_NOZZLE1          "D鐪塻e2"
	#define MSG_NOZZLE2          "D鐪塻e3"
	#define MSG_BED              "Bett"
	#define MSG_FAN_SPEED        "L鐪塮tergeschw."
	...
	#define MSG_CARD_MENU        "SDKarten Men鐪�
...
// Serial Console Messages
	...
	#define MSG_ERR_KILLED "闅嗛殕Impresora Parada con kill()!!"
	#define MSG_ERR_STOPPED "闅咺mpresora parada por errores. Arregle el error y use M999 Para reiniciar!. (La temperatura se reestablece. Ajustela antes de continuar)"
	...
	// LCD Menu Messages
	#define WELCOME_MSG MACHINE_NAME			" 琚氳姱瑜岃姱鑳�
	#define MSG_SD_INSERTED						"琚ｉ偑瑜夎閭�鑳佽瑜岄偑鑳佽阿姊拌柂閭�
	#define MSG_SD_REMOVED						"琚ｉ偑瑜夎閭�鎳堣煿鑳佽阿姊拌姊拌柂閭�
	#define MSG_MAIN							" 琚︽钖              \003"
	#define MSG_AUTOSTART						" 琚楄儊瑜岃姱瑜嬭閭瑜�         "
	#define MSG_DISABLE_STEPPERS				" 琚欒娉昏阿瑜炶鎳堣瑜�鍐欒儊鎳堣皭閭姊拌阿鎳�
	#define MSG_AUTO_HOME						" 琚╅偑瑜夋郴鑺儊娉婚偑           "
	#define MSG_SET_ORIGIN						" 琚熼偑閿岃姱灞戣柂鎳堣瑜�钖姱璋㈣     "
	#define MSG_PREHEAT_PLA						" 琚╄姊板啓钖偑璋愯姊拌儊 PLA     "
	#define MSG_PREHEAT_PLA_SETTINGS			" 琚ч偑瑜嬭瑜� 閿岃姊板啓钖偑璋愯.PLA"
	#define MSG_PREHEAT_ABS						" 琚╄姊板啓钖偑璋愯姊拌儊 ABS     "
	#define MSG_PREHEAT_ABS_SETTINGS			" 琚ч偑瑜嬭瑜� 閿岃姊板啓钖偑璋愯.ABS"
	#define MSG_COOLDOWN						" 琚ㄨ璋㈤偑鍗稿啓姊拌柂鎳堟         "
	#define MSG_SWITCH_PS_ON					"Switch Power On"
	#define MSG_SWITCH_PS_OFF					"Switch Power Off"
	#define MSG_EXTRUDE							" 鍗忔郴瑜嬭瑜夎锜规噲瑜�         "
	#define MSG_RETRACT							" 琚ㄨ娉婚偑瑜�
	#define MSG_MOVE_AXIS						" 琚涜儊鎳堝嵏姊拌柂鎳堟 閿岃姱 鑺瑜熷睉  \x7E"
	#define MSG_SPEED							" 灏忔郴鑺鑺瑜岃:"
	#define MSG_NOZZLE							" \002 鑲栨噲璋㈣姊拌閭�"
	#define MSG_NOZZLE1							" \002 鑲栨噲璋㈣姊拌閭�:"
	#define MSG_NOZZLE2							" \002 鑲栨噲璋㈣姊拌閭�:"
	#define MSG_BED								" \002 琚ｈ鑺儊閭瑜�"
	#define MSG_FAN_SPEED						" 琚ｈ璋㈣阿姊拌:"
	#define MSG_FLOW							" 琚╄姱瑜岃姱娉�"
	#define MSG_CONTROL							" 琚ч偑瑜嬭瑜夎姱娉勬郴鎳�\003"
	#define MSG_MIN								" \002 琚︽噲钖噲灞戣灞�"
	#define MSG_MAX								" \002 琚﹂偑娉昏鎳堝睉瑜嶅睉:"
	#define MSG_FACTOR							" \002 鑲栭偑娉昏鑺:"
	#define MSG_AUTOTEMP						" Autotemp:"
	#define MSG_ON								"琚欐郴璋� "
	#define MSG_OFF								"琚欒娉昏阿. "
	#define MSG_PID_P							" PID-P: "
	#define MSG_PID_I							" PID-I: "
	#define MSG_PID_D							" PID-D: "
	#define MSG_PID_C							" PID-C: "
	...
	#define MSG_AMAX							" Amax "
	#define MSG_A_RETRACT						" A-retract:"
	#define MSG_XSTEPS							" X 瑜曢偑璋�mm:"
	#define MSG_YSTEPS							" Y 瑜曢偑璋�mm:"
	#define MSG_ZSTEPS							" Z 瑜曢偑璋�mm:"
	#define MSG_ESTEPS							" E 瑜曢偑璋�mm:"
	#define MSG_RECTRACT    					" 琚ㄨ娉婚偑瑜�閿岃姱鍐欓偑瑜旀噲      \x7E"
	#define MSG_TEMPERATURE  				" 瀛濇灞戦攲姊拌閭瑜嶈閭�      \x7E"
	#define MSG_MOTION						" 灏忔郴鑺鑺瑜屾噲          \x7E"
		#define MSG_CONTRAST "LCD contrast"
	#define MSG_STORE_EPROM						" 灏忚姱瑜忚閭柂鎳堣瑜�钖偑瑜嬭瑜夎姱娉勬郴鎳�
	#define MSG_LOAD_EPROM						" 琚熼偑璋愯瑜嶈煿鎳堣瑜�钖偑瑜嬭瑜夎姱娉勬郴鎳�
	#define MSG_RESTORE_FAILSAFE				" 灏忔枩瑜夎姱瑜�钖偑瑜嬭瑜夎姱姊版郴     "
	#define MSG_REFRESH							"\004琚ㄦ枩钖姱鑳佹噲瑜岃           "
	#define MSG_WATCH							" 琚ㄦ枩锜硅姱瑜�            \003"
	#define MSG_PREPARE							" 琚涙娉勮瑜岃儊鎳堣          \x7E"
	#define MSG_TUNE					" 琚ч偑瑜嬭瑜夎姱娉勬郴鎳�        \x7E"
	#define MSG_PAUSE_PRINT						" 琚╅偑瑜嶈煿閭�閿屾瑜旈偑瑜屾噲      \x7E"
	#define MSG_RESUME_PRINT					" 琚╄鑺啓鑺阿鍗告噲瑜岃 閿屾瑜旈偑瑜岃 \x7E"
	#define MSG_STOP_PRINT						" 琚ㄨ瑜岄偑钖姱鑳佹噲瑜岃 閿屾瑜旈偑瑜岃 \x7E"
	#define MSG_CARD_MENU						" 琚︽钖 娉婚偑瑜夎瑜�       \x7E"
	#define MSG_NO_CARD							" 琚ф瑜�娉婚偑瑜夎瑜�
	#define MSG_DWELL							"灏忚姱钖�.."
	#define MSG_USERWAIT						"琚ч偑鍗稿睉鎳堣姊�鍐欒阿瑜�閿岃鑺啓鑺阿鍗�"
	#define MSG_RESUMING "Resuming print"
	#define MSG_NO_MOVE							"琚ф瑜�鍐欒儊鎳堝嵏姊拌柂鎳堣.       "
	#define MSG_PART_RELEASE					" 琚犺煿鑳佽阿姊拌姊拌柂鎳堟 閿岃鎳堣柂瑜岄偑  "
	#define MSG_KILLED							"鏍¤琚犲瓭琚� "
	#define MSG_STOPPED							"琚ㄥ皬瀛濊琚цⅷ琚欒ⅴ琚濊ⅶ琚� "
	#define MSG_CONTROL_RETRACT					" 琚ㄨ娉婚偑瑜�mm:"
	#define MSG_CONTROL_RETRACTF				" 琚ㄨ娉婚偑瑜� F:"
	#define MSG_CONTROL_RETRACT_ZLIFT			" 琚╄瑜樺嵏鑺郴 mm:"
	#define MSG_CONTROL_RETRACT_RECOVER			" 琚欒姱锜硅儊瑜夐偑瑜�+mm:"
	#define MSG_CONTROL_RETRACT_RECOVERF		" 琚欒姱锜硅儊瑜夐偑瑜� F:"
	#define MSG_AUTORETRACT						" 琚楄儊瑜岃姱琚ㄨ娉婚偑瑜�"
	#define MSG_FILAMENTCHANGE "Change filament"
	#define MSG_INIT_SDCARD "Init. SD-Card"	
	#define MSG_CNG_SDCARD "Change SD-Card"
    #define MSG_ZPROBE_OUT "ZProbe Outside Bed"
...
// Serial Console Messages
	...
	#define MSG_Enqueing						"琚熼偑閿岃阿閭柂鎳堣鑺儊閭柂鑺�\""
	#define MSG_POWERUP							"琚欐郴璋㈣瑜旀钖噲姊�閿屾噲瑜岄偑钖噲瑜�
	#define MSG_EXTERNAL_RESET					" 琚欒柂姊拌钖噲娉�瑜嬫枩瑜夎姱瑜�
	#define MSG_BROWNOUT_RESET					" Brown out 瑜嬫枩瑜夎姱瑜�
	#define MSG_WATCHDOG_RESET					" Watchdog 瑜嬫枩瑜夎姱瑜�
	#define MSG_SOFTWARE_RESET					" 閿岃鑺皭瑜夐偑灞戝睉钖娉�瑜嬫枩瑜夎姱瑜�
	#define MSG_MARLIN							"XIN "
	#define MSG_AUTHOR							" | 琚楄儊瑜岃姱瑜� "
	#define MSG_CONFIGURATION_VER				" 琚╄姱瑜嬭阿姊板啓钖姊�鑺枩钖姱鑳佽阿姊拌柂鎳堟: "
	#define MSG_FREE_MEMORY						" 琚╅偑灞戣瑜屾噲 瑜嬭儊鑺枩鑺啓钖姱: "
	#define MSG_PLANNER_BUFFER_BYTES			"  琚樿瑜庤姊拌 鑺姊拌姊板啓鎳�娉昏姱灞戦偑钖啓 Bytes: "
	#define MSG_OK								"ok"
	#define MSG_FILE_SAVED						"鑲栭偑娉勮阿 锜归偑閿屾噲瑜嬮偑钖�"
	#define MSG_ERR_LINE_NO						"琚ц姱灞戞钖�瑜嬭瑜夎姱娉绘噲 瑜濊鑺�钖 閿岃姱瑜嬭阿姊板啓钖瑜�瑜嬭瑜夎姱娉婚偑+1, 閿岃姱瑜嬭阿姊板啓钖瑜�瑜嬭瑜夎姱娉婚偑:"
	#define MSG_ERR_CHECKSUM_MISMATCH			"娉昏姱钖瑜夎姱璋㈣钖偑瑜�瑜嬭灞戝睉閭�钖 瑜嬭姱鑳侀攲閭啓閭瑜� 閿岃姱瑜嬭阿姊板啓钖瑜�瑜嬭瑜夎姱娉婚偑:"
	#define MSG_ERR_NO_CHECKSUM					"钖瑜�娉昏姱钖瑜夎姱璋㈣钖姱娉�瑜嬭灞戝睉瑜�鍐欒阿瑜�瑜嬭瑜夎姱娉绘噲, 閿岃姱瑜嬭阿姊板啓钖瑜�瑜嬭瑜夎姱娉婚偑:"
	#define MSG_ERR_NO_LINENUMBER_WITH_CHECKSUM	"钖瑜�瑜嬭瑜夎姱娉绘噲 鍐欒阿瑜�娉昏姱钖瑜夎姱璋㈣钖姱娉�瑜嬭灞戝睉瑜� 閿岃姱瑜嬭阿姊板啓钖瑜�瑜嬭瑜夎姱娉婚偑:"
	#define MSG_FILE_PRINTED					"琚╂瑜旈偑瑜岃 瑜庨偑娉勮阿閭�锜归偑鑳佹瑜夎姊拌柂閭�
	#define MSG_BEGIN_FILE_LIST					"灏忛攲鎳堣鑺郴 瑜庨偑娉勮阿鑺儊"
	#define MSG_END_FILE_LIST					"琚ｈ姱钖瑜�瑜嬮攲鎳堣娉婚偑 瑜庨偑娉勮阿鑺儊"
	#define MSG_M104_INVALID_EXTRUDER			"M104 鑺鎳堟枩娉婚偑 瑜濇郴瑜嬭瑜夎鍐欐瑜夐偑 "
	#define MSG_M105_INVALID_EXTRUDER			"M105 鑺鎳堟枩娉婚偑 瑜濇郴瑜嬭瑜夎鍐欐瑜夐偑 "
	#define MSG_M218_INVALID_EXTRUDER			"M218 鑺鎳堟枩娉婚偑 瑜濇郴瑜嬭瑜夎鍐欐瑜夐偑 "
	#define MSG_ERR_NO_THERMISTORS				"琚ф瑜�瑜屾瑜夊睉鎳堣瑜岃閭�- 钖瑜�瑜屾灞戦攲姊拌閭瑜嶈瑜�
	#define MSG_M109_INVALID_EXTRUDER			"M109 鑺鎳堟枩娉婚偑 瑜濇郴瑜嬭瑜夎鍐欐瑜夐偑 "
	#define MSG_HEATING							"琚ч偑璋愯姊拌儊...  "
	#define MSG_HEATING_COMPLETE				"琚ч偑瑜夎皭姊拌鑺�    "
	#define MSG_BED_HEATING						"琚ч偑璋愯姊拌儊 瑜嬭鑺阿閭�..     "
	#define MSG_BED_DONE						"灏忚鑺阿 钖偑璋愯姊拌.        "
	#define MSG_M115_REPORT						"FIRMWARE_NAME:XIN S1; Sprinter/grbl mashup for gen6 FIRMWARE_URL:" FIRMWARE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) " UUID:" MACHINE_UUID "\n"
	#define MSG_COUNT_X							" Count X:"
	#define MSG_ERR_KILLED						"琚╄鎳堣柂瑜屾瑜�鑺瑜岄偑钖姱鑳佽阿姊拌柂. 鑳佽锜硅姱鑳�kill() !!"
	#define MSG_ERR_STOPPED						"琚ㄨ鎳堟枩娉婚偑 閿岃鎳堣柂瑜屾瑜夐偑, 鑺瑜岄偑钖姱鑳� 鏍¤瑜岃閭柂鎳堣姊�钖鎳堣閿岃閭儊钖姱瑜嬭瑜�鎳�鎳堣閿岃姱璋㈣锜硅娉勮姊�M999 鍐欒阿瑜�閿屾瑜夋锜归偑璋愯瑜嶈煿娉绘噲!. (瀛濇灞戦攲姊拌閭瑜嶈閭�钖鍐欒姱瑜嬭瑜嶉攲钖偑. 琚╄鑺儊姊拌瑜滆姊�鍐欓偑瑜岃鎳堟郴鎳�"
	#define MSG_RESEND							"琚╂瑜夋鑺閿岃閭儊娉婚偑:"
	#define MSG_UNKNOWN_COMMAND					"琚ф鎳堣煿鑳佹瑜嬭钖偑瑜�娉昏姱灞戦偑钖啓閭�\""
	#define MSG_ACTIVE_EXTRUDER					"琚楁郴瑜屾噲鑳佽柂瑜樻硠 瑜濇郴瑜嬭瑜夎鍐欐瑜� "
	#define MSG_INVALID_EXTRUDER				"琚ㄨ鎳堟枩娉婚偑 瑜濇郴瑜嬭瑜夎鍐欐瑜夐偑"
	#define MSG_X_MIN							"x_min:"
	#define MSG_X_MAX							"x_max:"
	#define MSG_Y_MIN							"y_min:"
	#define MSG_Y_MAX							"y_max:"
	#define MSG_Z_MIN							"z_min:"
	#define MSG_Z_MAX							"z_max:"
	#define MSG_M119_REPORT						"灏忚閭瑜嶈 娉昏姱钖姊拌儊鎳堟郴鑺儊"
	#define MSG_ENDSTOP_HIT						"灏忚閭枩閭瑜樿儊閭柂鎳堟 娉昏姱钖姊拌儊鎳堟郴閭�
	#define MSG_ENDSTOP_OPEN					"琚ｈ姱钖姊拌儊鎳堟郴 鑺鑳佽姱鏂滆姱鍗稿啓姊拌柂"
	#define MSG_HOTEND_OFFSET					"Hotend offsets:"
	#define MSG_SD_CANT_OPEN_SUBDIR				"琚ф 鑺娉昏瑜樿瑜�閿岄偑閿屾郴瑜�
	#define MSG_SD_INIT_FAIL					"琚ㄨ鎳堟枩娉婚偑 鎳堣柂鎳堣鎳堥偑璋㈡噲锜归偑瑜戞噲鎳�SD"
	#define MSG_SD_VOL_INIT_FAIL				"琚ㄨ鎳堟枩娉婚偑 鎳堣柂鎳堣鎳堥偑璋㈡噲锜归偑瑜戞噲鎳�瑜夐偑锜瑰啓姊拌阿閭�
	#define MSG_SD_OPENROOT_FAIL				"琚ф 閿岃鑺姊拌瑜岃 瑜嬭姱鍐欐瑜夊嵏鎳堝睉鑺 娉昏姱瑜夎柂瑜�
	#define MSG_SD_CARD_OK						"SD 娉婚偑瑜夎閭�鑳�閿岃姱瑜夎鍐欐郴姊�
	#define MSG_SD_WORKDIR_FAIL					"钖 鑺娉昏瑜樿瑜�瑜夐偑鏂滆姱瑜旇瑜�閿岄偑閿屾郴瑜�
	#define MSG_SD_OPEN_FILE_FAIL				"琚ㄨ鎳堟枩娉婚偑 瑜旇姊拌柂鎳堣, 瑜庨偑娉勮阿: "
	#define MSG_SD_FILE_OPENED					"鑲栭偑娉勮阿 鑺娉昏瑜樿:"
	#define MSG_SD_SIZE							" 琚偑锜瑰睉姊拌:"
	#define MSG_SD_FILE_SELECTED				"鑲栭偑娉勮阿 鑳佽鏂滆閭柂"
	#define MSG_SD_WRITE_TO_FILE				"琚熼偑閿屾噲瑜嬭 鑳�瑜庨偑娉勮阿: "
	#define MSG_SD_PRINTING_BYTE				"SD 閿屾瑜旈偑瑜岃 byte "
	#define MSG_SD_NOT_PRINTING					"钖瑜�SD 閿屾瑜旈偑瑜屾噲"
	#define MSG_SD_ERR_WRITE_TO_FILE			"鑺鎳堟枩娉婚偑 锜归偑閿屾噲瑜嬫噲 鑳�瑜庨偑娉勮阿"
	#define MSG_SD_CANT_ENTER_SUBDIR			"琚ф 锜归偑娉勮鎳�鑳�閿岄偑閿屾郴瑜�"
	#define MSG_STEPPER_TOO_HIGH				"鏁堥偑瑜嬭鑺閭�瑜曢偑璋愯姱鑳�鑺姊拌柂瑜�鑳佽瑜嬭姱娉婚偑 : "
	#define MSG_ENDSTOPS_HIT					"娉昏姱钖姊拌儊鎳堟郴 瑜嬭閭枩鑺閭阿: "
	#define MSG_ERR_COLD_EXTRUDE_STOP			" 锜归偑瑜栨噲瑜岄偑 瑜忚姱璋㈣姱鍐欒柂鑺硠 瑜濇郴瑜嬭瑜夎锜规噲鎳�
	#define MSG_ERR_LONG_EXTRUDE_STOP			" 锜归偑瑜栨噲瑜岄偑 閿岃姊拌儊瑜樿姊拌柂鎳堣 鍐欒阿鎳堣柂钖 瑜濇郴瑜嬭瑜夎锜规噲鎳�
...
// Serial Console Messages
	...
	#define MSG_BEGIN_FILE_LIST "Come鑾給 da lista de arquivos"
	#define MSG_END_FILE_LIST "Fim da lista de arquivos"
	#define MSG_M104_INVALID_EXTRUDER "M104 Extrusor inv璋﹍ido "
	#define MSG_M105_INVALID_EXTRUDER "M105 Extrusor inv璋﹍ido "
	#define MSG_M218_INVALID_EXTRUDER "M218 Extrusor inv璋﹍ido "
	#define MSG_ERR_NO_THERMISTORS "Nao ha termistor - no temp"
	#define MSG_M109_INVALID_EXTRUDER "M109 Extrusor inv璋﹍ido "
	...
	#define MSG_ERR_STOPPED "Impressora parada por erros. Coserte o erro e use M999 para recome鑾絘r!. (Temperatura reiniciada. Ajuste antes de recome鑾絘r)"
	#define MSG_RESEND "Reenviar:"
